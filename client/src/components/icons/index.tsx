...
export const StocksIcon = (props: any) => (
    ...
    <svg  viewBox="0 0 16 18" fill="none" >
        <mask id="path-1-inside-1_748_0" fill="white">
            <path d="M7.88867 15.999L-0.000449071 8L8.11 0.000983039L15.9991 8.00001L7.88867 15.999Z" />
        </mask>
        <path d="M7.88867 15.999L-0.000449071 8L7.88867 15.999ZM8.12957 -2.82738L17.4231 6.59561L14.5752 9.4044L8.09044 2.82934L8.12957 -2.82738ZM15.9991 8.00001L7.88867 15.999L15.9991 8.00001ZM-1.40485 6.57604L8.12957 -2.82738L8.09044 2.82934L1.40395 9.42396L-1.40485 6.57604Z" fill={props.selected ? "#00A3FE" : "#808080"} mask="url(#path-1-inside-1_748_0)" />
        <path d="M6 12H10V17H6V12Z" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <mask id="path-4-inside-2_748_0" fill="white">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M2 8V16H14V8H16V16V18H14H2H0V16V8H2Z" />
        </mask>
        <path d="M2 8H4V6H2V8ZM2 16H0V18H2V16ZM14 16V18H16V16H14ZM14 8V6H12V8H14ZM16 8H18V6H16V8ZM16 18V20H18V18H16ZM0 18H-2V20H0V18ZM0 8V6H-2V8H0ZM0 8V16H4V8H0ZM2 18H14V14H2V18ZM16 16V8H12V16H16ZM16 6H14V10H16V6ZM18 16V8H14V16H18ZM18 18V16H14V18H18ZM14 20H16V16H14V20ZM2 20H14V16H2V20ZM0 20H2V16H0V20ZM-2 16V18H2V16H-2ZM-2 8V16H2V8H-2ZM2 6H0V10H2V6Z" fill={props.selected ? "#00A3FE" : "#808080"} mask="url(#path-4-inside-2_748_0)" />
    </svg>
...
export const ExpenseIcon = (props: any) => (
    ...
    <svg viewBox="0 0 11 10" fill="none" >
        <path d="M2.39258 1.26324L9.3881 1.51349" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <path d="M9.13672 8.5087L9.42271 0.513811" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <path d="M1.47656 8.77603L8.86691 2.54147" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
    </svg>
)

export const InvoiceIcon = (props: any) => (
    <svg  viewBox="0 0 19 21" fill="none" >
        <path d="M11.5117 0.813232L16.7271 5.48225" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <path d="M6.84961 19.8886L1.67326 15.1764" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <path d="M12.0586 10.6977L17.3946 4.73722" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <path d="M6.38477 10L0.999321 15.9158" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <path d="M6 6L15.6687 5.9386" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
        <path d="M12.4043 14.7479L2.73545 14.7289" stroke={props.selected ? "#00A3FE" : "#808080"} stroke-width="2" />
    </svg>
...
export const ExploreIcon = (props: any): ReactElement => {
    return (
        <NavIcon h={20} w={20} className='icn' {...props} >
            <svg viewBox="0 0 512 512">
                <rect x="48" y="48" width="176" height="176" rx="20" ry="20" fill="none" stroke="rgb(83,100,113)" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                <rect x="288" y="48" width="176" height="176" rx="20" ry="20" fill="none" stroke="rgb(83,100,113)" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                <rect x="48" y="288" width="176" height="176" rx="20" ry="20" fill="none" stroke="rgb(83,100,113)" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
                <rect x="288" y="288" width="176" height="176" rx="20" ry="20" fill="none" stroke="rgb(83,100,113)" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" />
            </svg>
        </NavIcon>
    )
}
...
export const CheckIcon = (props: any) => (
    <svg viewBox="0 0 18 16" fill="none">
        <line stroke="#00A3FE" x1="0.587785" y1="8.13776" x2="8.94193" y2="14.2074" stroke-width="2.5" />
        <path stroke="#00A3FE" d="M8.34493 13.3218L16.8756 1.07228" stroke-width="2.5" />
    </svg>
)
export const Marker = (props: any) => (
    <svg viewBox="0 0 18 15" fill="none">
        <line  x1="0.587785" y1="8.06574" x2="8.94193" y2="14.1354" stroke-width="2.5" />
        <path  d="M8.34493 13.2495L16.8756 1.00001" stroke-width="2.5" />
    </svg>
)
...
export const SuccessMarkIcon = (props: any) => {
    const { color } = props;
   return <svg width="18" height="15" viewBox="0 0 18 15" fill="none">
        <line x1="0.587785" y1="8.06574" x2="8.94193" y2="14.1354" stroke={color || '#3DD542'} stroke-width="2" />
        <path d="M8.34493 13.2495L16.8756 1.00001" stroke={color || '#3DD542'} stroke-width="2" />
    </svg>
}
   

export const Logo = () => (
    <svg className='logo' width="40" height="40" viewBox="0 0 39 38" fill="none" >
        <mask id="path-1-inside-1" fill="white">
