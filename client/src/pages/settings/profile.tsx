...
import { AccDateItem, AccHeaderItem, AccountInfoCont, AccountInfoItem, AccSectionHeader, BillingInfoCont, FeedbackCont, LinkeAccInfoItem, ListContainer, LoaderCont, ModalContainer, SettingSection } from './styles'
...
import CreditCardForm from '../../components/forms/settings/card'
interface Props {
                    ...
                    <>
                        ...
                        <SettingSection>
                            <AccSectionHeader>
                                ...
                                <AccHeaderItem end>
                                    <IconCont style={{ alignSelf: 'end' }} onClick={() => openForm('card')} size={14}>
                                        <PlusIcon />
                                    </IconCont>
                                </AccHeaderItem> {
                                    visibleForm === "card" && <CreditCardForm />
                                }
                                <Divider />
                            </AccSectionHeader>
                            <ListContainer>
                        ...
                        <SettingSection>
                            <AccSectionHeader>
                                ...
                                <AccHeaderItem end>
                                    <IconCont style={{alignSelf:'end'}} onClick={() => openForm('account')} size={14}>
                                        <PlusIcon />
                                    </IconCont>
                                </AccHeaderItem> {
                            ...
                            <ListContainer> {
                                data?.accDetails.linkedTo.length ?
                                    data.accDetails.linkedTo.map((link: any, i: number) => (
                                        <BillingInfoCont key={link._id}>
                                            ...
                                            {i !== data.accDetails.linkedTo.length-1 && <Divider />}
